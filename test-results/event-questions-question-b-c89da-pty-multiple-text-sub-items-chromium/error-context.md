...
- Name: event-questions.spec.ts >> question builder CRUD, validation, and type properties >> validates blank labels, empty choices, and empty multiple-text sub-items
- Location: e2e\event-questions.spec.ts:176:7
...
- textbox "Email address":
  ...
  - text: playwright-1786165701717-ft4zcm@example.test
- text: Password
- textbox "Password":
  - /placeholder: ••••••••
