...
- Name: event-questions.spec.ts >> event creation wizard >> creates a complete event with multiple configured question types
- Location: e2e\event-questions.spec.ts:66:7
...
- textbox "Email address":
  ...
  - text: playwright-1786165701701-fg1v4z@example.test
- text: Password
- textbox "Password":
  - /placeholder: ••••••••
