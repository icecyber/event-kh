...
- Name: event-questions.spec.ts >> question builder CRUD, validation, and type properties >> creates, edits, duplicates, reorders, discards, saves, and deletes questions
- Location: e2e\event-questions.spec.ts:141:7
...
- textbox "Email address":
  ...
  - text: playwright-1786165701740-ommgtb@example.test
- text: Password
- textbox "Password":
  - /placeholder: ••••••••
