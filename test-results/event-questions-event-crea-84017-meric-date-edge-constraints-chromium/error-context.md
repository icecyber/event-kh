...
- Name: event-questions.spec.ts >> event creation wizard >> guards required fields and native numeric/date edge constraints
- Location: e2e\event-questions.spec.ts:105:7
...
- textbox "Email address":
  ...
  - text: playwright-1786165701658-lwxrdz@example.test
- text: Password
- textbox "Password":
  - /placeholder: ••••••••
