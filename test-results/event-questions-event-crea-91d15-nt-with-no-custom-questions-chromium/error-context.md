...
- Name: event-questions.spec.ts >> event creation wizard >> surfaces create API errors and permits an event with no custom questions
- Location: e2e\event-questions.spec.ts:124:7
...
- textbox "Email address":
  ...
  - text: playwright-1786165701674-4uc597@example.test
- text: Password
- textbox "Password":
  - /placeholder: ••••••••
