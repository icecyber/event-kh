...
import { draftToPayload, type QuestionDraft } from "@/components/QuestionEditor";
import QuestionListEditor, { draftsFromFields } from "@/components/QuestionListEditor";
...
export default function EditEventForm({
  ...
  onSaved?: () => void;
  /**
   * When false, the Registration Questions section is hidden and
   * `customFields` is omitted from the PATCH payload so this form cannot
   * modify or delete questions. Used when questions live in their own tab.
   */
    ...
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      ...
      {showQuestions && (
        <div style={sectionStyle}>
          ...
          <QuestionListEditor fields={fields} onChange={setFields} />
        </div>
      )}
